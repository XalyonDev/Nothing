...
echo ""
echo "============================================"
echo "      Atom Worker Auto Installer"
echo "============================================"
echo ""
...
# -------------------------------------------------------
WORKER_JS_URL="https://xalyondev.github.io/Nothing/worker.js"

echo "[+] Downloading worker.js..."
curl -sSL "$WORKER_JS_URL" -o worker.js || wget -qO worker.js "$WORKER_JS_URL"
...
echo "   http://$SERVER_IP:4000/run-job"
echo ""
echo " View logs:"
echo "   pm2 logs atom-worker"
echo ""
echo " Restart:"
echo "   pm2 restart atom-worker"
echo ""
echo " Stop:"
echo "   pm2 stop atom-worker"
echo ""
echo "============================================"
